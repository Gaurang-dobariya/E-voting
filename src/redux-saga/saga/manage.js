...
import { delete_connection, delete_election, delete_party, delete_voter, get_connection, get_election, get_party, get_voter, post_connection, post_election, post_party, post_voter } from "../redux/api"
import { DELETE_ELECTION_ERROR, DELETE_ELECTION_SUCCESS, DELETE_PARTYLIST_ERROR, DELETE_PARTYLIST_SUCCESS, DELETE_PARTY_ERROR, DELETE_PARTY_SUCCESS, DELETE_USER_ERROR, DELETE_USER_SUCCESS, GET_ELECTION_LIST_ERROR, GET_ELECTION_LIST_SUCCESS, GET_PARTYLIST_LIST_ERROR, GET_PARTYLIST_LIST_SUCCESS, GET_PARTY_LIST_ERROR, GET_PARTY_LIST_SUCCESS, GET_USER_LIST_ERROR, GET_USER_LIST_SUCCESS, POST_CREATE_PARTY_ERROR, POST_CREATE_PARTY_SUCCESS, POST_ELECTION_CREATE_ERROR, POST_ELECTION_CREATE_SUCCESS, POST_PARTYLIST_CREATE_ERROR, POST_PARTYLIST_CREATE_SUCCESS, POST_USER_CREATE_ERROR, POST_USER_CREATE_SUCCESS } from "../redux/action"
